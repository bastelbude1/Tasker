...
echo "------------------------------------------------------------"
./intelligent_test_runner.py ../functional/metadata_example_test.txt
echo
...
echo "------------------------------------------------------------"
./intelligent_test_runner.py ../functional/metadata_branching_test.txt
echo
...
echo "------------------------------------------------------------"
./intelligent_test_runner.py ../functional/metadata_variables_test.txt
echo
...
echo "------------------------------------------------------------"
./intelligent_test_runner.py ../functional/metadata_security_test.txt
echo
...
echo "------------------------------------------------------------"
./intelligent_test_runner.py ../functional/metadata_execution_path_test.txt
echo
